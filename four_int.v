...
module four_int (
    ...
    output  [1:0] l0_dir,
    output  reg [1:0] l1_dir,
    output  reg [1:0] l2_dir,
    output  reg [1:0] l3_dir,
...
assign l0_dir = (timer != 0) ? (sensor[0] ? W : l0_dir_normal) : l0_dir_normal;
